...
| Report schema 7 | `modules/app/src/report.cpp`, documented by `schema/report.json` | CLI `--report`, the panel, and `report_test` which checks emitted reports against the schema |
